...
export default function Post({ params }: PostPageTypes) {
    ...
    const [resolvedParams, setResolvedParams] = useState<{ userId: string, postId: string } | null>(null)
    ...
    }, [resolvedParams, setPostById, setCommentsByPost, setLikesByPost, setPostsByUser])
    ...
    if (!userId || !postId) {
        return <div>Error: Missing parameters</div> // Handle missing parameters if necessary
    }
        ...
        <>
            ...
            >
                <div className="lg:w-[calc(100%-540px)] h-full relative">
                    {/* Accessing params after unwrapping */}
                    <Link
                        href={`/profile/${userId}`}
