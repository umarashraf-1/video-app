...
const handleShare = async () => {
    try {
        ...
        await navigator.clipboard.writeText(`${baseUrl}/post/${post?.id}/${post?.profile?.user_id}`);
  
   
        setIsCopied(true);
        setTimeout(() => setIsCopied(false), 2000);      } catch (error) {
                ...
                <div className="absolute bottom-0 pl-2">
                    ...
                    <button className="text-center">
                        <div className="rounded-full bg-gray-200 p-2 cursor-pointer">
                         ...
                         {/* Success Popup */}
      {isCopied && (
        <div className="absolute top-0 left-0 mt-8 bg-green-500 text-white p-2 rounded-md shadow-lg text-sm">
